    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
				...
				<td class="tableContent"><input type="text" name="offeror" value="XXX商贸有限公司" /></td>
	        </tr>
			<tr>
				...
				<td class="tableContentAuto">
					...
					<input type="radio" name="printStyle" value="1" class="input"  checked />一款
			...
			<tr>
				...
				<td class="tableContent">
					<input type="text" style="width: 90px" name="signingDate"
						onclick="WdatePicker({e1:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});" />
				</td>
